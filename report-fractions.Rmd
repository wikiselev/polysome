---
title: "Analysis of polysome fractions"
...
# Monosome (4-7) correlations and PCA
...
tmp <- as.matrix(d[,grepl("_[4-7]", colnames(d), perl = TRUE)])
...
# Light fractions (8-10) correlations and PCA
...
# Heavy fractions (11-16) correlations and PCA

```{r, echo=FALSE, cache=TRUE, fig.width=10, fig.height=10}
tmp <- as.matrix(d[,grepl("_1[1-6]", colnames(d), perl = TRUE)])
cor_heatmap(tmp[,order(colnames(tmp))], "polysome")
```
